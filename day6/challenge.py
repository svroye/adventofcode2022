...
print(index_of_marker("mjqjpqmgbljsphdztnvjfqwrcgsmlb", 4))  # 7
print(index_of_marker("bvwbjplbgvbhsrlpgdmjqwftvncz", 4))  # 5
print(index_of_marker("nppdvjthqldpwncqszvftbrmjlhg", 4))  # 6
print(index_of_marker("nznrnfrfntjfmvfwmzdfjlvtqnbhcprsg", 4))  # 10
print(index_of_marker("zcfzfwzzqfrljwzlrfnpqdbhtmscgvjw", 4))  # 11

print(index_of_marker(data, 4))
